...
@LargeTest
public class FocusActivity_IntraFocusColleagueById_Test {

    @Rule
    public ActivityTestRule<FocusActivity.IntraFocusColleagueById> mActivityRule = new ActivityTestRule(FocusActivity.IntraFocusColleagueById.class);
